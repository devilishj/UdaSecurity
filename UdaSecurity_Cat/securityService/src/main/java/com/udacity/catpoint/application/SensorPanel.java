 ...
 */
public class SensorPanel extends JPanel implements SensorLabelListener {
    ...
    public SensorPanel(SecurityService securityService) {
        ...
        this.securityService.addSensorLabelListener(this);
     ...
     */
    void setSensorActivity(Sensor sensor, Boolean isActive) {
